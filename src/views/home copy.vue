<template>
  <div class="flex flex-col h-screen">
    ...
    <div class="sticky bottom-0 w-full p-6 pb-8 bg-gray-100">
      ...
      <div class="flex">
        <input class="input" :type="isConfig ? 'password' : 'text'" :placeholder="isConfig ? 'sk-xxxxxxxxxx' : '请输入'" v-model="messageContent" @keydown.enter="isTalking || sendOrSave()" />
...
请告诉我你需要哪方面的帮助，我会根据你的需求给你提供相应的信息和建议。`
  ...
  const scrollToBottom = () => {
    ...
    chatListDom.value.scrollTop = 99999
  }
